...
g4.test_1k_rows_rollback_w_index_wo_batch = function()
    ...
    local res, err = storage:call(
        ...
        { "EMPLOYEES_HOT", "EMPLOYEES_TRANSFER", "EMPLOYEES_TRANSFER_HIST", 2, nil }
    )
    local cnt1_1 = storage:call("storage_space_count", { "EMPLOYEES_HOT" })
    local cnt1_2 = storage:call("storage_space_count", { "EMPLOYEES_TRANSFER" })
    local cnt1_3 = storage:call("storage_space_count", { "EMPLOYEES_TRANSFER_HIST" })
...
g4.test_1k_rows_rollback_w_index_w_batch = function()
    ...
    local res, err = storage:call(
        "reverse_history_in_scd_table",
        { "EMPLOYEES_HOT", "EMPLOYEES_TRANSFER", "EMPLOYEES_TRANSFER_HIST", 2, 100 }
    )
    local cnt1_1 = storage:call("storage_space_count", { "EMPLOYEES_HOT" })
    local cnt1_2 = storage:call("storage_space_count", { "EMPLOYEES_TRANSFER" })
    local cnt1_3 = storage:call("storage_space_count", { "EMPLOYEES_TRANSFER_HIST" })
...
g4.test_1k_rows_rollback_wo_index_wo_batch = function()
    ...
    local _, _ = storage:call(
        "transfer_stage_data_to_scd_table",
        { "EMPLOYEES_HOT", "EMPLOYEES_TRANSFER_2", "EMPLOYEES_TRANSFER_HIST_2", 1 }
    )
...
g6.test_all_dtm_types_check_data_w_column = function()
    local storage = cluster:server("master-1-1").net_box
    storage.space.orig__as2__all_types_table_actual:insert({
        1,
        7729,
        3,
        nil,
        ...
        100000,
        18594,
        tonumber64("1605647472000000ULL"),
        100000000,
        "d92beee8-749f-4539-aa15-3d2941dbb0f1",
        "c",
    })
