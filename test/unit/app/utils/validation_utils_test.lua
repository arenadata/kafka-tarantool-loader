...
g.test_check_valid_input = function ()
    local res,err = validate_utils.check_kafka_bootstrap_definition(
...
g2.test_check_valid_input = function()
    local input1 = {["enable.auto.offset.store"] = "true",
...
g2.test_check_invalid_input = function()
    ...
    local input3 = {["enable.auto.offset.store"] = "true",
                    ["group.id"] = 123,
                    ["auto.offset.reset"] = "earliest",
                    ["enable.partition.eof"] = "false"}
