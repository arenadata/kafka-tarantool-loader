...
g2.test_scan_simple_directory = function()
    ...
    t.assert_equals(
        files,
        { "test/unit/data/simple_files/multiline.txt", "test/unit/data/simple_files/singleline.txt" }
    )
    t.assert_equals(err, nil)
...
g3.test_simple_write = function()
    ...
    local res1, err1 = file_utils.write_file(
        "/tmp/" .. file_name1,
        one_string,
        { "O_RDWR", "O_CREAT" },
        { "S_IRUSR", "S_IWUSR" }
    ...
    local res2, err2 = file_utils.write_file(
        "/tmp/" .. file_name2,
        two_string,
        { "O_RDWR", "O_CREAT" },
        { "S_IRUSR", "S_IWUSR" }
