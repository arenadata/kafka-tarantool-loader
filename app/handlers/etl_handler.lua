...
local function get_scd_table_checksum (req)
    ...
    local is_ok,res = _G.get_scd_table_checksum_on_cluster(body.actualDataTableName,body.historicalDataTableName,body.sysCn,body.columnList, body.normalization)
