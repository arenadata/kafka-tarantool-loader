...
local function convert_lua_types_for_checksum(value,delimeter)
    ...
    if value_type == 'nil' or value == nil then return ''
    elseif value_type == 'number' then return string_value
    elseif value_type == 'string' then return value
    elseif value_type == 'boolean' then
        if value == false then
            return '0'
        else return '1'
        end
    elseif value_type == 'userdata' then return string_value
    ...
    elseif value_type == 'function' then return ''
    elseif value_type == 'thread' then return ''
    else return string_value
    end
end
