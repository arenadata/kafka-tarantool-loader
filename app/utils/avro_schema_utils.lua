...
local function get_schema_registry_key_schema_name()
    if schema_registry_opts["key_schema_name"] == nil then
        ...
        return schema_registry_opts["key_schema_name"]
    end
end
...
local function get_schema(schema_name)
    local ok, latest_version = get_latest_version(
        schema_registry_opts["host"],
        schema_registry_opts["port"],
        schema_name
    )
    ...
    local ok, schema = get_schema_from_schema_registry(
        schema_registry_opts["host"],
        schema_registry_opts["port"],
        schema_name,
        "latest"
